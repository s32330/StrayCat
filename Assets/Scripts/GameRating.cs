...
public class GameRating : MonoBehaviour
{
    ...
    public string descriptionA = "Bardzo dobrze! Kilka ma³ych b³êdów.";
    public string descriptionB = "Dobrze, ale mo¿esz lepiej.";
    public string descriptionC = "Œrednio, trzeba popracowaæ.";
    public string descriptionD = "le, spróbuj ponownie!";
    ...
    // Funkcja ustawiaj¹ca opis w zale¿noœci od oceny
